	...
	if matches[1]:lower() == 'معلوماتي' then
		function get_id(arg, data)
			...
			if data.first_name_ then
                ...
                local text = '<b> اهلآ وسهلآ بك 😻✋️معلوماتك :</b>\n\n<b>[♦️] الاسم الاول :</b> <i>'..data.first_name_..'</i>\n\n<b>[♦️] الاسم الثاني :</b> <i>'..lastName..'</i>\n\n<b>[♦️] المعرف:</b> '..username..'\n\n<b>[♦️] الايدي :</b> [ <code>'..data.id_..'</code> ]\n\n<b> [♦️] ايدي الكروب :</b> [ <code>'..arg.chat_id..'</code> ]\n\n<b>[♦️] موقعك :</b> <i>'..rank..'</i>\n\n 🔹🔸🔹🔸🔹🔸🔹🔸🔹\n #المطور @Dev_Hussein5_6'
